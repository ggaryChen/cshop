/*
 * @Author: garychen 
 * @Date: 2017-08-09 00:16:58 
 * @Last Modified by: garychen
 * @Last Modified time: 2017-08-09 00:18:05
 */
...
var addressModal = {
    ...
    bindEvent :  function(){
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            // 验证不通过
                ...
                _cshop.errorTips(receiverInfo.errMsg || '好像哪里不对了~');
            }
        });
    ...
    loadModal : function(){
        var addressModalHtml = _cshop.renderHtml(templateAddressModal, {
